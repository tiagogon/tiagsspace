...
Front posts for Sidewalk Series

*/ ?>

	<div id="sidewalk-block" class="front-block series-block">

		<div class="block-header">
			<h1>On the Sidewalk</h1>
		</div>

		<?php // Get Sidewalk Series posts ?>
		<div class="container-fluid block-content">
			...
			<div class="clearfix row no-pad">
			    ...
			    while ($my_query->have_posts()) : $my_query->the_post();
			        ...
			        <figure class="col-sm-24 col-md-12 thumb-series thumb-sidewalk <?php echo "item".$count.$hidden; ?>">
