...
*/ ?>
    ...
    <div class="swiper-container-films hidden-xs">
        ...
        <div class="swiper-wrapper">
            ...
            $args = array(
                ...
                //'orderby' => 'meta_value_num', // create a number field on ACF to activate
                //'order' => 'ASC',
                'meta_query' => array(
                    array(
            ...
            while ($my_query->have_posts()) : $my_query->the_post();
                ...
                if( get_field('different_slider_image') ) {
			...
			<div class="swiper-slide">
                ...
                <a href="<?php echo get_permalink(); ?>">
                    ...
                    <div class="slider-cap">
						...
						<?php if (get_field('slider_excerpt')) { ?>

                        	<p class="hidden-xs excerpt"> <?php echo $excerpt; ?></p>
	...
	<script>
		...
		var mySwiper = new Swiper ('.swiper-container-films', {
