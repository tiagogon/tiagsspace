		...
		<div class="clearfix row">
			<div class="<?php content_wrap() ?>">
				<ul class="social-links">
					<li>
						<a href="https://www.instagram.com/tiagsssss/" data-hover="Facebook" target="_blank">Insta</a>
					</li>
					<li>
					...
					<li>
						<a href="https://troubleplace.tumblr.com" data-hover="SoundCloud" target="_blank">Tumblr</a>
					</li>
					<li>
						<a href="https://imtakingtwo.tumblr.com" data-hover="SoundCloud" target="_blank"> References</a>
					</li>
					<li>
